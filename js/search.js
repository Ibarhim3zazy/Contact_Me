function date_fun() {
    document.getElementById('search_form').innerHTML = '<input type="date" name="search"><input type="hidden" name="type" value="date_result"><button type="submit">اذهب</button>';
}
