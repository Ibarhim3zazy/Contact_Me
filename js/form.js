(function() {
  (function() {
    ...
    document.body.insertAdjacentHTML('beforeend', '<a href="index.php" target="_blank" class="mM">' + logo + '</a>');
...
function count_arrows() {
  let count_arrows = document.getElementById('money').value / 100;
  document.getElementById('arrows').value = count_arrows;
}
