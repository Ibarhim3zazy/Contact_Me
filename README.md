# افعل الخير ولا تتوقف عن فعله ♥️
...
- فرع المنصوره:
1. محمد الشريف ( قسم حاسب )
2. دعاء غنيم ( قسم حاسب )
3. أمنيه راشد ( قسم حاسب )
- فرع منيه النصر:
1. مصطفى اسامه ( قسم حاسب )
- فرع ميت غمر:
1. ابراهيم السيد عزازى ( قسم حاسب )
2. مي اسامه ( قسم اعلام )
